        ...
        private void SendEmailConfirmation(string toEmail, string subject, string body)
        {
            System.Net.Mail.MailMessage m = new
                System.Net.Mail.MailMessage(
                        new System.Net.Mail.MailAddress("syedusman.elod@gmail.com", "Confirmation"),
                        new System.Net.Mail.MailAddress(toEmail));
            m.Subject = subject;
            m.Body = body;
            m.IsBodyHtml = true;
            System.Net.Mail.SmtpClient smtp = new System.Net.Mail.SmtpClient("smtp.gmail.com");
            smtp.Credentials = new System.Net.NetworkCredential("syedusman.elod@gmail.com", "lums1242");
            smtp.EnableSsl = true;
            smtp.Send(m);
        }
